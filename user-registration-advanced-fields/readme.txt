...
* Fix       - Profile photo cropping causes image and buuttons to disappear.
...
= 1.6.18    - 12/01/2026
* Enhance   - Profile picture upload process design.

= 1.6.17    - 13/11/2025 =
* Fix       - Profile upload not working on mobile phone.
* Tweak     - Minimized rows height in form builder for wysiwyg.

= 1.6.16   - 07/10/2025 =
* Tweak    - Update tooltips and labels of form field settings in Field Options.
* Enhance  - Updated css for wysiwyg.

= 1.6.15   - 21/08/2025 =
* Tweak    - Remove read_more tag from WYSIWYG editor for URM.
* Fix      - Misalignment of profile picutre field in form preview.

= 1.6.14   - 17/07/2025 =
* Tweak    - Consistent drop-down for login and registration form builder setting.

= 1.6.13   - 19/06/2025 =
* Tweak    - Auto prefixing for the custom url.
* Dev      - Modify the image resolution for cropped image.

= 1.6.12   - 16/04/2025 =
* Dev      - Checkout sync field block for WooCommerce.
* Fix      - Fields not validating with WooCommerce on checkout page.
...
* Dev      - Added filter for displaying only allowed countries in smart phone field.
* Fix      - Form id not found on login with registration shortcode.
* Fix      - Validation issue when multi-select2 field has only one field.

= 1.6.9    - 01/08/2024
* Enhance  - Placeholder in select2 and multiselect2.
* Dev      - Trigger latest pro version update for pro v4.1.4 users.
* Dev      - Advanced Fields compatibility with Repeater Fields Addon.

= 1.6.8    - 15/04/2024
* Tweak    - Addon update check triggered from User Registration Pro.
* Fix      - Design issue in multiselect-2 field of advanced field addon.
* Dev      - Compatiblity for Added smart phone number in billing phone number.

= 1.6.7    - 05/03/2024
* Fix      - Check Plugin Update once a day.
* Fix      - Handle Frontend validation for smart phone field.

= 1.6.6    - 12/12/2023
* Refactor - Timepicker library changed from timepicker to flatpickr.
* Feature  - Time range selection in time picker field.
