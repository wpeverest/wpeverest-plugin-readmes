...
= 1.4.3    - 22/07/2026 =
* Fix      - Conditional Logic on Payments not working.
...
* Fix      - Payment id and amount not showing correctly on payments table.

= 1.3.16    - 27/04/2026 =
* Enhance   - Logger structure.

* Fix       - Broken access control during stripe customer creation.
* Fix       - Field Mapping hidden in subscription options for stripe.
* Fix       - Stripe payment details not updating for normal registration.
