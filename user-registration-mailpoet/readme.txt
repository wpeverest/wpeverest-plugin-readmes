=== User Registration MailPoet ===
Contributors: WPEverest
Tags: user registration, addon, mailpoet
...
MailPoet addon for User Registration

== Description ==

MailPoet synchronization for user registration plugin.
...
* Enhance  - Membership plan support on mailpoet.

= 1.1.0    - 13/11/2025 =
* Feature  - Conditional logic support.
...
= 1.0.1    -18/11/2024 =
* Enhance  - Move Mailpoet Settings to Integration Settings in Form Settings
